...
$(function(){
    ...
    */
     ...
     */
    $(".btn-danger").on("click", ()=>{
        $("main h2").css({"background-color":"orange", "color":"red"});
        $("aside h2").css({"background-color":"blue", "color":"black"});
        $("main h3").css({"color":"orange"});
        $("aside h3").css({"color":"blue"});
        $("img").css({"border":"5px solid grey"});
        $(".btn-danger").hide(1000);
        $(".copyright").hide(1000);
        $(".copyright1").html("&copy; 2020, Adam Rychtář");
    });
})